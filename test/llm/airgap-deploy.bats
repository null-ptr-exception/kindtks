...
# LLM-driven air-gap deployment test.
#
# An AI agent is given only the container image and must figure out
# how to install and deploy a gen1 cluster from the help output alone.
# The test independently verifies the cluster state — it never trusts
